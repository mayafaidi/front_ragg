...
function StyledMarkdownComponent({ msg }) {
  const isArabic = /[\u0600-\u06FF]/.test(msg.text);
  ...
  return (
    <Box
      sx={{
        ...
        "& blockquote": {
          borderLeft: isArabic ? "none" : "4px solid rgba(0,188,212,0.6)",
          borderRight: isArabic ? "4px solid rgba(0,188,212,0.6)" : "none",
          backgroundColor: "rgba(255,255,255,0.05)",
          padding: "10px 14px",
          borderRadius: "8px",
          fontStyle: "italic",
...
// ✅ Memoization لمنع إعادة الريندر غير الضرورية
export default memo(StyledMarkdownComponent, (prevProps, nextProps) => {
